...
@export var effect: bool = false
@export var effectAccuracy: int = 100
@export_enum("self", "enemy", "both") var effectTarget: String
@export var effectTime: float = 2.0
@export var damageBack: int = 0

# Percentage chance to apply status conditions to enemy
@export var enemyStatusCondition: Dictionary = {
	"burn": 0,
	"sleep": 0,
	"paralysis": 0,
	"poison": 0,
...
@export var selfStatusCondition: Dictionary = {
	"burn": 0,
	"sleep": 0,
	"paralysis": 0,
	"poison": 0,
...
@export var enemyEffects: Dictionary = {
	"hp": {"reduce": 0, "add": 0},
	"atk": {"reduce": 0, "add": 0},
	"def": {"reduce": 0, "add": 0},
...
@export var selfEffects: Dictionary = {
	"hp": {"reduce": 0, "add": 0},
	"atk": {"reduce": 0, "add": 0},
	"def": {"reduce": 0, "add": 0},
	"atkSp": {"reduce": 0, "add": 0},
...
@export var unaffected: Dictionary = {
	"all": false,
	"damage": false,
	"status": false,
	"effects": false,
